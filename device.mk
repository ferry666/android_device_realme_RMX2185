...
PRODUCT_COPY_FILES += \
    ...
    $(DEVICE_PATH)/permissions/privapp-permissions-whitelist-system_ext.xml:$(TARGET_COPY_OUT_SYSTEM)/system-ext/etc/permissions/privapp-permissions-whitelist-system_ext.xml \
