...
PRODUCT_COPY_FILES += \
    ...
    $(DEVICE_PATH)/permissions/privapp-permissions-whitelist-system-ext.xml:$(TARGET_COPY_OUT_SYSTEM)/system-ext/etc/permissions/privapp-permissions-whitelist-system-ext.xml \
